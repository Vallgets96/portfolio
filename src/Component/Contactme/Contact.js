    ...
    return(
        <div className="bg-black  text-white flex flex-col gap-24 pt-52 " id="Contact">
            <div className=" pt-[80px]" data-aos="fade-up" data-aos-duration="1500" >
                ...
                <h1 className="absolute font-bold text-[30px] opacity-20 left-[30%] md:text-[54px] md:left-[238px] lg:text-[70px] lg:left-[32%] xl:text-[100px] xl:left-[32%] xl:bottom-2  ">Contact Me</h1>

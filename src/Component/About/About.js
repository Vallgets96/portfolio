...
function About (){
    ...
    return(
        <div className="bg-black relative text-white" id="About">
            ...
            <h1 className="absolute font-bold text-[28px] opacity-20 left-[12px] md:text-[53px] md:left-[8px] lg:text-[72px]  lg:top-[28px] lg:left-[26px] xl:text-[92px] xl:left-[14px] xl:top-[4px] ">About</h1>

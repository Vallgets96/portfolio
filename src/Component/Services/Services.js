        ...
        <div>
            <div className=" bg-black text-white ">
               <div className="text-center relative p-5 " data-aos="fade-up" data-aos-duration="1500" id="Services">
                    <h1 className="absolute font-bold text-[30px] opacity-20 left-[33%] md:text-[55px] md:left-[36%] lg:text-[71px] lg:left-[37%] xl:text-[100px] xl:left-[575px] xl:bottom-[18px]">Services</h1>
            ...
            <div className="bg-black  text-white  grid grid-cols-1 md:grid-cols-2  xl:grid-cols-3 pt-[80px] p-8 gap-9  lg:p-14">
                ...
                <div className="flex flex-col justify-center items-center" >
                    <div className="bg-[#1A1A1A] w-full h-[200px]  group relative text-center md:h-[240px] " data-aos="fade-up" data-aos-duration="1500">
